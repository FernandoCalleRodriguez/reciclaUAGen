...
/*PROTECTED REGION ID(usingreciclaUAGenReciclaUAAdminRESTAzure_RespuestaControllerAzure) ENABLED START*/
...
// No pasa el slEnables: buscarRespuestasPorUsuario

[HttpGet]

[Route ("~/api/Respuesta/BuscarRespuestasPorUsuario")]

public HttpResponseMessage BuscarRespuestasPorUsuario (int id_usuario)
{
        // CAD, CEN, EN, returnValue
        ...
        try
        {
                ...
                en = respuestaCEN.BuscarRespuestasPorUsuario (id_usuario).ToList ();
...
/*PROTECTED REGION ID(reciclaUAGenReciclaUAAdminRESTAzure_RespuestaControllerAzure) ENABLED START*/
