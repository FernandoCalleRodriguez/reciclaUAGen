...
// No pasa el slEnables: buscarPuntosPorValidarCount

[HttpGet]

[Route ("~/api/PuntoReciclaje/BuscarPuntosPorValidarCount")]

public HttpResponseMessage BuscarPuntosPorValidarCount (           )
{
        // CAD, CEN, EN, returnValue
        ...
        try
        {
                ...
                returnValue = puntoReciclajeCEN.BuscarPuntosPorValidarCount (    );
